    ...
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <G clipPath="url(#clip0_1045_2090)">
        ...
        <Path 
          fillRule="evenodd" 
          clipRule="evenodd" 
          d="M12 23.9993C15.24 23.9993 17.9564 22.9248 19.9418 21.092L16.0636 18.0811C14.9891 18.8011 13.6145 19.2266 12 19.2266C8.87455 19.2266 6.22909 17.1157 5.28546 14.2793H1.27637V17.3884C3.25091 21.3102 7.30909 23.9993 12 23.9993Z" 
          fill="#34A853"
        />
        <Path 
          fillRule="evenodd" 
